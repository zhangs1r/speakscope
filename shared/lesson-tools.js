...
(function () {
  ...
  function addInlineVocabButtons() {
    ...
    if (!document.getElementById('ss-inline-vocab-style')) {
      ...
      style.textContent =
        ...
        'border:1px solid #DDD5C8;background:#F7F4EE;border-radius:4px;' +
        'cursor:pointer;font-size:12px;line-height:1;' +
        'vertical-align:middle;transition:all 0.15s;' +
        '}' +
        '.ss-vocab-inline-btn:hover{' +
        'background:#F0DDD0;border-color:#C9957A;' +
        '}' +
  ...
  function buildUI() {
    ...
    toolbar.style.cssText =
      ...
      'background:#F7F4EE;border:1px solid #F0ECE4;' +
    ...
    doneBtn.style.cssText =
      'padding:8px 16px;border:1px solid #DDD5C8;border-radius:6px;' +
      'cursor:pointer;font-size:0.9rem;background:#F7F4EE;' +
      'transition:all 0.15s;';
    doneBtn.onmouseover = function () { this.style.borderColor = '#E8C4B0'; };
    doneBtn.onmouseout = function () { this.style.borderColor = '#DDD5C8'; };
    doneBtn.onclick = toggleDone;

    if (isDone()) {
      doneBtn.textContent = '✅ 已学 ✓';
      doneBtn.classList.add('done');
      doneBtn.style.background = '#F0DDD0';
      doneBtn.style.borderColor = '#C9957A';
    } else {
      doneBtn.textContent = '✅ 标记为已学';
    }
    ...
    vocabBtn.style.cssText =
      ...
      'cursor:pointer;font-size:0.9rem;background:#F7F4EE;' +
      'transition:all 0.15s;';
    vocabBtn.onmouseover = function () { this.style.borderColor = '#E8C4B0'; };
    vocabBtn.onmouseout = function () { this.style.borderColor = '#DDD5C8'; };
